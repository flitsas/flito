...
//
// SOLO los tres catálogos. El resto de contratos del módulo —registros consolidados, corridas de
// sync, metadatos del token SIMIT y eventos del timeline— los añade la HU #11502 cuando exista lo
// que describen. Publicar hoy un tipo de algo que todavía no devuelve ningún endpoint invita a que
// la pantalla se escriba contra una forma que aún puede cambiar.
//
