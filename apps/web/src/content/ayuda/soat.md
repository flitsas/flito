...
8. Como Cliente, si su compañía tiene el canal abierto, pulse **Solicitar SOAT** en el encabezado: se abre el formulario de la solicitud. Escriba la placa, el VIN y el **tipo y número de documento** del propietario **antes** de pulsar **Consultar el RUNT**; después complete el resto de los datos del propietario y adjunte la factura de venta en PDF. Si el canal está apagado, en lugar del botón verá una tarjeta que lo explica; la cola sigue funcionando igual.
