...
6. En el encabezado, **Cargar recibos (masivo)** sube los PDF, las imágenes o un ZIP del organismo. Sueltos caben **hasta 150 archivos**; dentro de un ZIP, **hasta 300**, y cada archivo puede pesar **hasta 15 MB**. Al elegir un ZIP, FLITO lo abre en su computador y le dice cuántos recibos trae: el peso que ve (**N archivos · X MB de 250 MB**) es el de lo que va a subir, no el del ZIP comprimido. Lo que no sea PDF ni imagen se ignora y se lo dice. La casilla **Archivos sueltos sin marca de agua** sigue aplicando a lo suelto; dentro del ZIP, la copia se deduce por la carpeta. Si el ZIP está dañado, tiene contraseña o no trae recibos, no se envía nada. Y si un archivo del ZIP resulta pesar más de lo que el ZIP decía, FLITO para ahí y se lo dice: lo que ya subió se queda. FLITO sube los recibos **de 5 en 5** y le muestra por cuál va.
