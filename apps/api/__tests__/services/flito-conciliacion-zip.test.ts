...
//
// Los zips van fabricados a mano —80 líneas de formato zip— porque hace falta poder MENTIR en las
// cabeceras: ninguna librería escribe un central directory que declare 1 KB para 40 MB de datos, y
// ese es justo el caso que la segunda pasada tiene que atrapar.
...
import { medirXlsx } from '../../src/modules/flito-conciliacion/flito-conciliacion.zip.js';
import {
...
// ── Un escritor de zips que se deja mentir ───────────────────────────────────
...
function zipDe(entradas: EntradaFalsa[]): Buffer {
...
function xlsxFalso(hoja: EntradaFalsa, hojasExtra = 0): Buffer {
