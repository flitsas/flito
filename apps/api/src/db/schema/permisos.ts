 ...
 * Es la MISMA lista que el tipo `CampoAuditable` y que el CHECK de la 0185 (el test de paridad lo
 ...
 * duplicada como CHECK en la 0185 y aquí abajo: el tipo impide pasar la fila entera, el CHECK impide
 * el INSERT crudo.
 * RN-03: inmutable por REVOKE (0185), no por disparador: la retención de 6 años (`archivar_offline`,
