 ...
 * repetir el error de diagnóstico del Bug #11711: los 5 municipios verificados contra el proveedor
 * el 2026-08-21 (BELLO, MEDELLIN, ITAGUI, ENVIGADO y SABANETA) responden SIEMPRE con
 * `Content-Length` y NINGUNO con `Transfer-Encoding: chunked` — y aun así esta acumulación se
 ...
 * contra el proveedor el 2026-08-21. Los 5 municipios consultados (BELLO, MEDELLIN, ITAGUI,
 * ENVIGADO y SABANETA) contestan `HTTP 200`, `Content-Type: application/json; charset=utf-8`,
...
export interface OpcionesGetJson {
   ...
   * devuelve el resultado ya serializado como texto en los 5 municipios medidos el 2026-08-21
   * (Bug #11711).
   */
