  ...
  try {
    ...
    const respuesta = await conLimiteDeTiempo(
      () => httpsGetJson(url, {
        ...
        // en los 5 municipios consultados (BELLO, MEDELLIN, ITAGUI, ENVIGADO y SABANETA), todos con
        // `Content-Length` y todos con la comilla doble como primer byte del cuerpo.
        //
